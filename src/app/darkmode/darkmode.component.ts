...
export class DarkmodeComponent implements OnInit {
  ...
  private backgroundDarkColor = "rgba(51,51,51,0.7)";
  private backgroundLightColor = "rgba(255,255,255,0.7)";
  ...
  checkValue() {
    ...
    if(!this.isDarkMode) {
      ...
      document.documentElement.style.setProperty('--background-primary-color',this.backgroundDarkColor);
    } else {
      ...
      document.documentElement.style.setProperty('--background-primary-color',this.backgroundLightColor);
    }
  }
}